...
[![Build Status](https://travis-ci.org/TuXiaokang/SeetaFaceEngine.svg?branch=master)](https://travis-ci.org/TuXiaokang/SeetaFaceEngine)
...
Pretrained weights can be downloaded [here](http://198.13.45.221/files)
